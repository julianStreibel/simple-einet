...
@hydra.main(version_base=None, config_path="./conf", config_name="flow_spn_config")
def main(cfg: DictConfig):
    ...
    if cfg.load_and_eval:
        model = load_from_checkpoint(
            results_dir, load_fn=FlowSPN.load_from_checkpoint, cfg=cfg
        )
    else:
        model = FlowSPN(cfg)
    ...
    # Create callbacks
    logger_wandb = WandbLogger(name=cfg.tag, project="flow_spn", group=cfg.group_tag,
