...
from models_pl.cnn_mixing_einet import CnnSpnMixingEinet
...
@hydra.main(version_base=None, config_path="./conf", config_name="cnn_mixing_einet_config")
def main(cfg: DictConfig):
    ...
    if cfg.load_and_eval:
        model = load_from_checkpoint(
            results_dir, load_fn=CnnSpnMixingEinet.load_from_checkpoint, cfg=cfg
        )
    else:
        model = CnnSpnMixingEinet(cfg)
    ...
    # Create callbacks
    logger_wandb = WandbLogger(name=cfg.tag, project="cnn_mixing_einet", group=cfg.group_tag,
