...
class CnnSpnMixingEinet(LitModel):
    ...
    def __init__(self, cfg: DictConfig):
        ...
        self.spn = make_einet(cfg, num_classes=10,
                              einet_class=MixingEinet, num_channels_multiplyer=channel_multipler)

        # self.cnn = nn.Conv2d(
        #     in_channels=3,
        #     out_channels=3 * channel_multipler,
        #     kernel_size=9,
        #     stride=1,
        #     padding=4
        # )
        ...
        self.cnn = nn.Sequential(
            ...
            nn.Conv2d(
                in_channels=3 * channel_multipler,
                out_channels=3 * channel_multipler,
                kernel_size=9,
                stride=1,
                padding=4
