...
from models_pl import ClassSpn
...
@hydra.main(version_base=None, config_path="./conf", config_name="mixing_class_einet_config")
def main(cfg: DictConfig):
    ...
    if cfg.load_and_eval:
        model = load_from_checkpoint(
            results_dir, load_fn=ClassSpn.load_from_checkpoint, cfg=cfg
        )
    else:
        model = ClassSpn(cfg)
    ...
    # Create callbacks
    logger_wandb = WandbLogger(name=cfg.tag, project="class_einet", group=cfg.group_tag,
