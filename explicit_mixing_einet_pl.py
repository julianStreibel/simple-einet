...
from models_pl.explicit_mixing_einet import SpnExplicitMixingEinet
...
@hydra.main(version_base=None, config_path="./conf", config_name="explicit_mixing_einet_config")
def main(cfg: DictConfig):
    ...
    if cfg.load_and_eval:
        model = load_from_checkpoint(
            results_dir, load_fn=SpnExplicitMixingEinet.load_from_checkpoint, cfg=cfg
        )
    else:
        model = SpnExplicitMixingEinet(cfg)
    ...
    # Create callbacks
    logger_wandb = WandbLogger(name=cfg.tag, project="explicit_mixing_einet", group=cfg.group_tag,
